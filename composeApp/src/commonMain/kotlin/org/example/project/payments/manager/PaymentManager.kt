...
import org.example.project.payments.services.ApiKeyService
...
class PaymentManager(
    ...
    val statusFlow = statusChannel.consumeAsFlow()
    ...
    private fun validatePayload(payload: CheckoutPayload) {
